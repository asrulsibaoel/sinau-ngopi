define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Option Parameter usage:",
        "content": "?q=&page=1&sortby=created_at&order=desc&filters[chats_rooms_id]=&filters[id]=",
        "type": "json"
      }
    ],
    "parameter": {
  ...
  {
    "type": "post",
    "url": "/api/transactions_detail/create",
  ...
  {
    "type": "GET",
    "url": "/api/transactions_detail/{ID}",
  ...
  {
    "type": "GET",
    "url": "/api/transactions_detail/delete/{ID}",
