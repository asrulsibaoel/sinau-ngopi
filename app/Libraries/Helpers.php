...
*/
    ...
    function optionList($object,$request,$with="",$custom_filters=null,$custom_filters_or=null){
        ...
        // filters automatic from get parameter
        ...
        // custom from call function parameter
        ...
        // custom from call function parameter
        if(is_array($custom_filters_or))
        foreach ($custom_filters_or as $field=>$filter) {
            if(!empty($filter))
            $query_object=$query_object->OrWhere($field,$filter);
        }
